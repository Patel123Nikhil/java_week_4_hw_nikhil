...
public class Programme_3_FindVowelOrConsonant {
    ...
    public static boolean isItALetter(String letter) {
        return letter.charAt(0) > 96 && letter.charAt(0) < 123;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter my character: ");
        String str = scanner.next().toLowerCase();
        //Calling static method directly
        checkVowe10rConstant(str);
